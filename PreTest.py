...
def nextQuestion(frame,subject):
    ...
    if answered == False:
        ...
        Question = Message(Questionframe,width=480, text= ParsedQuestion[questionIndex],font=("Arial", 13,))
        ...
        Radiobutton(Questionframe,wraplength=300, justify=LEFT, font=("Arial", 12,), text = multChoices[0],variable=v, value="answer1",command=lambda:checkAns(frame, correctAns, multChoices[0])).grid(row=1, column = 1, sticky=W)
        Radiobutton(Questionframe,wraplength=300, justify=LEFT, font=("Arial", 12,),text = multChoices[1],variable=v, value="answer2",command=lambda:checkAns(frame, correctAns, multChoices[1])).grid(row=2, column = 1, sticky=W)
        Radiobutton(Questionframe,wraplength=300, justify=LEFT, font=("Arial", 12,), text = multChoices[2],variable=v, value="answer3",command=lambda:checkAns(frame, correctAns, multChoices[2])).grid(row=3, column = 1, sticky=W)
        Radiobutton(Questionframe,wraplength=300, justify=LEFT, font=("Arial", 12,), text = multChoices[3],variable=v, value="answer4",command=lambda:checkAns(frame, correctAns, multChoices[3])).grid(row=4, column = 1, sticky=W)
...
def main(Root, frame, subject):
    ...
    button = Button(NextFrame, bg = "#82E0AA", text="Next Question",command = lambda:nextQuestion(frame, subject))
    button.pack(anchor = E)